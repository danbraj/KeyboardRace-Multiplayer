...
![Struktura aplikacji](assets\img\apps-presentation.png)
...
1. (tylko aplikacja serwera) Utworzyć folder `Texts` w głównym katalogu serwera i dodać kilka plików tekstowych `.txt` 
...
* **App** - Klasa zawierająca stałe statyczne wykorzystywane w aplikacjach klienta oraz serwera. Pełni rolę podstawowych ustawień aplikacji. Ustawieniu podlegają:
  * nazwa aplikacji,
  * wersja aplikacji,
...
* Obszar tekstowy - informuje o kluczownych zdarzeniach serwera
